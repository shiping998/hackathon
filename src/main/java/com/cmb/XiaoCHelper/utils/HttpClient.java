...
public class HttpClient {
     ...
     * @return
     */
    public static String sendJSONPostRequest(String url, Map<String, String> params){
        RestTemplate client = new RestTemplate();
        //新建Http头，add方法可以添加参数
        HttpHeaders headers = new HttpHeaders();
        // 以JSON的方式提交
        ...
        //执行HTTP请求，将返回的结构使用String 类格式化（可设置为对应返回值格式的类）
        ResponseEntity<String> resEntity = client.postForEntity(url, requestEntity, String.class);
